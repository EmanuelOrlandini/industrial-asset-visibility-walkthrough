...
- **Análisis Manual:** Identificación de fabricantes mediante direcciones MAC (`arp -a` + lookup OUI) y verificación manual de servicios web en puertos comunes (80, 443) **solo con fines de identificación**.
...
Se identificó un dispositivo activo (`192.168.30.195`) con los puertos **80 (HTTP) y 443 (HTTPS)** accesibles desde toda la red interna.

**Investigación posterior reveló:**
- **Modelo:** TP-Link EAP225-Outdoor (confirmado por dirección MAC `30:68:93:63:06:6c`).
...
*Conectemos en [LinkedIn](https://linkedin.com/in/tu-perfil) | [GitHub](https://github.com/tu-usuario)*
